...
-------|--------------|-------------------\n\t\
 ...
 -p    | PROCESS_DATA | At interval specified with -c (default is 30 seconds), data thus far will be processed using SpRIT CLI and plotted in terminal\n\t\
...
# Format the times for later creation of time window for export (-tw option)
...
echo "Program will end in 5 seconds"
sleep 5
