"""This script contains all the functions, classes, etc. to create a tkinter app for pyinstaller app.
"""
import datetime
import functools
import linecache
...
resource_dir = pathlib.Path(pkg_resources.resource_filename(__name__, 'data/'))
    ...
    if can_gui:
        ...
        try:
            try:
                ...
                icon_path = pathlib.Path(pkg_resources.resource_filename(__name__, 'data/icon/sprit_icon.png'))
